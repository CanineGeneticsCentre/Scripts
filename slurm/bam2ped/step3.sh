...
gatk -T VariantAnnotator -R ${CF3}/ensembl/canfam3.fasta -o ${OUTPUT_PATH}/output.g.vcf --resource:hd_chip ${CF3}/Canine170K.ens.vcf --expression hd_chip.ID -V  ${OUTPUT_PATH}/${SAMPLE}.g.vcf
