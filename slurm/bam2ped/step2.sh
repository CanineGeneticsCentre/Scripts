...
gatk -T VariantFiltration -R ${CF3}/ensembl/canfam3.fasta -o ${OUTPUT_PATH}/output.g.vcf --filterExpression "QUAL < 30.0" --filterName "homREF" --variant ${OUTPUT_PATH}/${SAMPLE}.g.vcf
