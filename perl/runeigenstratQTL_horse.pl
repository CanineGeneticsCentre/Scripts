...
print "\n";
print "#########################\n";
print "# Runsmarteigenstrat v2 #\n";
print "# (QTL mode)  HORSE     #\n";
print "#########################\n\n";
...
$logfilename  = $f.".eigenlog";
$parfile = $f.".par";

#########################
# Some other parameters #
#########################
$qtmode = "YES";   # whether this is a QTL or not
...
$cmd = "/opt/eigensoft/horse/smarteigenstrat -p $parfile >$logfilename";
print "$cmd\n";
system($cmd);
