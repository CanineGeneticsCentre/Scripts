...
print "#   SNPTEST association software.       #\n";
print "#                                       #\n";
print "#   (ped files must contain phenotypes) #\n";
print "#########################################\n";
print "\n";
...
#####################################
#  Run SNPTEST - Basic association  #
#####################################
print "\nRunning SNPTEST - Basic association...\n\n";

$command = "/opt/snptest/snptest";  
$command .= " -cases $filename.gen_cases $filename.sample_cases";
$command .= " -controls $filename.gen_controls $filename.sample_controls";
$command .= " -o $filename"."_frequentist.out";
$command .= " -frequentist 1 2 3 4 5";

print("$command\n");
system("$command");

print RESULTS "Running SNPTEST to carry out a basic association analysis.\n";
print RESULTS " $command\n\n";


########################################
#  Run SNPTEST - Bayesian association  #
########################################
...
$command .= " -cases $filename.gen_cases $filename.sample_cases";
$command .= " -controls $filename.gen_controls $filename.sample_controls";
$command .= " -o $filename"."_bayesian.out";
...
print RESULTS "Running SNPTEST to carry out a Bayesian association analysis.\n";
print RESULTS " $command\n\n";


#################################################
# Run snptest_convert to convert the long files #
# into columns for plotting in EXcel 2003       #
#################################################

$command = "perl /home/genetics/scripts/snptest_convert.pl -f $filename"."_frequentist.out";
print("$command\n");
system("$command");

print RESULTS "Converting the frequentist output file for Excel 2003 using snptest_convert\n";
print RESULTS " $command\n\n";


$command = "perl /home/genetics/scripts/snptest_convert.pl -f $filename"."_bayesian.out";
print("$command\n");
system("$command");

print RESULTS "Converting the bayesian output file for Excel 2003 using snptest_convert\n";
print RESULTS " $command\n\n";
...
print "$filename"."_frequentist.out\n";
print "$filename"."_bayesian.out\n\n";
...
&move_to_results_folder ("_bayesian.out");
&move_to_results_folder ("_frequentist.out");
...
&delete_unwanted (".gen_cases");
&delete_unwanted (".gen_controls");
&delete_unwanted (".sample_cases");
&delete_unwanted (".sample_controls");
&delete_unwanted (".ped");
&delete_unwanted (".map");
&delete_unwanted (".hh");
...
print README " > $filename"."_frequentist.out\n\n";
...
print README " > $filename"."_bayesian.out\n\n";
...
print "##############################################\n";
print "##############################################\n";
print "##         SNPTEST analysis complete        ##\n";
print "##############################################\n";
print "##############################################\n";
...
print "    4.  $filename"."_frequentist.out  	\t-  for basic association results.\n\n";
print "    5.  $filename"."_bayesian.out  	\t-  for Bayesian association results.\n\n";
