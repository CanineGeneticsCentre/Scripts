...
$command =  "/usr/bin/java16 -jar /opt/picard/CreateSequenceDictionary.jar R=$ref O=$ref.dict";
...
$command =  "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -R $ref -I aligned_sorted.bam -T CountCovariates -cov ReadGroupCovariate -cov QualityScoreCovariate -cov CycleCovariate -cov DinucCovariate -recalFile reads.csv --default_platform $platform";
...
$command =  "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -R $ref -I aligned_sorted.bam -T TableRecalibration -outputBam recal.bam -recalFile reads.csv --default_platform $platform";
...
$command =  "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -T RealignerTargetCreator -I recal.bam -R $ref -o forRealigner.intervals";
...
$command =  "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -I recal.bam -R $ref -T IndelRealigner -targetIntervals forRealigner.intervals --output cleaned.bam";
...
$command =  "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -T IndelGenotyperV2 -R $ref -I cleaned_sorted.bam -O indels.raw.bed -o detailed.output.bed --verbose";
...
$command =  "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -T IndelGenotyperV2 -R $ref -I cleaned_sorted.bam -O indels.raw.bed -o detailed.output.bed --verbose --window_size 800";
...
$command =  "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -R $ref -T UnifiedGenotyper -I cleaned_sorted.bam -stand_emit_conf 10.0 -varout snps.raw.vcf -stand_call_conf 50.0 --platform SOLEXA";
...
$command =  "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -R $ref -T UnifiedGenotyper -I cleaned_sorted.bam -varout snps.raw.vcf -stand_emit_conf 10.0 -stand_call_conf 50.0 --platform ROCHE454";
...
$command = "/usr/bin/java16 $mem -jar /opt/gatk/GenomeAnalysisTK.jar -R $ref -I cleaned_sorted.bam -o depth -T DepthOfCoverage -omitBaseOutput";
