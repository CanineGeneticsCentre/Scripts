...
print "\n";
print "#########################################\n";
print "#     RUNSMARTPCA_QTL perl script v4    #\n";
print "#     (horse version)                     #\n";
print "#########################################\n";
print "\n";
...
$command = "/opt/eigensoft/smartpca_horse";          # RUN OLD VERSION UNTIL V3.0 IS SORTED OUT
$command .= " -p $parfile >$l";

print "Running SMARTPCA_horse for QTL... (principal components analysis)\n";
print("$command\n");
system("$command");
