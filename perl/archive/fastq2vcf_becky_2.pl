...
if (index($version,"w") > -1)
{
	...
	$no_of_threads_gatk_ug_nt	= "12";  # UnifiedGenotyper -nt (but NOT HaplotypeCaller)
	...
	$no_of_threads_gatk_rtc_nt	= "12"; # RealignerTargetCreator         <== This one is used for RealignerTargetCreator
	$workstation 				= "true";
...
if (substr($answer,0,1) eq "2" ){$ref = "/home/genetics/canfam3.1.1_new/canfam3.1.1_new.fasta"; $ref_seq_name = "canfam3"; $species = "canis_familiaris";$dummy_dbsnp_file = "/home/genetics/canfam3/canfam3_dummy_DBSNP.vcf"; $all_snps_file = "/home/genetics/canfam3/canfam3.1.1_snps_all.vcf" }
