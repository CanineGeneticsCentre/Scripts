...
print "\n";
print "#########################################\n";
print "#     RUNSMARTPCA perl script v4        #\n";
print "#     (horse version)                     #\n";
print "#########################################\n";
print "\n";
...
$command = "/opt/eigensoft/horse/smartpca";          # New version 3 of eigensoft programs
$command .= " -p $parfile >$l";
print "Running SMARTPCA_horse... (principal components analysis)\n";
print("$command\n");
system("$command");
...
$command = "perl /home/genetics/scripts/ind2pheno.perl $b $f.pheno";
print "\nRunning IND2PHENO...(converts indiv file to pheno file for EIGENSTRAT)\n";
print("$command\n");
system("$command");
print "\n";
